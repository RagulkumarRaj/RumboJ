...
<title>${product.get("title").getAsString()}-Buy Products Online at RumboJ.com</title>
   ...
   <div class="row">
     ...
     <div class="col-md-5">
	    <div class="row">
		  ...
		  <h5 style="color:#555!important">Best Price - ${product.get("flipkartprice").getAsString()}</h5>
...
<table class="table table-bordered">
  <tbody>
    <tr>
      <td>Screen Size</td>
      <td>${product.get("touchscreen").getAsString()}</td>
    </tr>
    <tr>
      <td>Ram</td>
